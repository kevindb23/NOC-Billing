...
{
    protected $fillable = ['subscriber_service_id', 'billing_account_id', 'plan_version_id', 'status', 'starts_on', 'ends_on', 'next_billing_date', 'billing_day', 'price_snapshot_minor', 'currency_snapshot', 'plan_name_snapshot'];
