...
class AuthController extends Controller
{
    public function login(Request $request): JsonResponse
    {
        ...
        return response()->json(['data' => ['token' => $token, 'user' => $user, 'organization' => $organization]]);
    }

    public function me(Request $request): JsonResponse
    {
        return response()->json(['data' => ['user' => $request->user(), 'organization' => $request->attributes->get('organization')]]);
    }
