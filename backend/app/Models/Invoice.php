...
class Invoice extends Model
{
    ...
    protected $fillable = ['billing_account_id', 'invoice_number', 'status', 'issue_date', 'due_date', 'billing_period_start', 'billing_period_end', 'currency', 'subtotal_minor', 'discount_minor', 'tax_minor', 'total_minor', 'amount_paid_minor', 'balance_due_minor', 'voided_at'];
