...
export function CrudModal({ open, mode, title, description, fields, initialValues, error, loading, onClose, onSubmit, renderExtra, wide }: {
  open: boolean
